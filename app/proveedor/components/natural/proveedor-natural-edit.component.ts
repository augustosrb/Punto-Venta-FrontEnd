...
@Component({
	selector: 'proveedor-natural-edit',
	templateUrl: 'app/proveedor/view/natural/proveedor-natural-edit.html'
})
export class ProveedorNaturalEditComponent implements OnInit {
