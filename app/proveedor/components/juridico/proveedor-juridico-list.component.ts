...
@Component({
  selector: 'proveedor-juridico-list',
  templateUrl: 'app/proveedor/view/juridico/proveedor-juridico-list.html'
})

export class ProveedorJuridicoListComponent {
  ...
  getAllProveedores(search:string=null) {
    ...
    this._route.params.subscribe(params => {
      ...
      //llamada al servicio
      this._proveedorService.getProveedoresJ(page,this.searchString).subscribe(
        response => {
  ...
  search()
  {
    ...
    {
      this._router.navigate(["/proveedor-list/search/",this.searchString]);
    }else
    {
      this._router.navigate(["/proveedor-list/"]);
    }
  }
}
